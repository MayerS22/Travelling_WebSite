    ...
    <section class="services" id="services">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>provide minimum amenities and services for a lower price than a regular hotel in the area. The hotels provide clean rooms that are safe and meet the basic needs of a guest. Extra amenities may be available, but for an extra cost.</p>
            </div>
            <div class="box">
                <i class="fas fa-utensils"></i>
                <h3>Food and drinks</h3>
                <p>Food can include a wide range of styles and cuisine types. These can be classified by country. Beverages include all alcoholic and non-alcoholic drinks. Alcoholic beverages include wines and all other types of alcoholic drinks such as Cocktails, Beer, Ciders, Spirits, and Liqueurs.</p>
            </div>
            <div class="box">
